        ...
        {options.map((option, i) => (
          <div
            ...
            className={cn(
              ...
              selectedOption === option && "border-blue-400 bg-blue-50 text-blue-500",
              status === "correct" && selectedOption === option && "border-green-500 bg-green-100 text-green-700",
              status === "incorrect" && selectedOption === option && "border-rose-500 bg-rose-100 text-rose-700",
               // Disabled state look
               status !== "idle" && selectedOption !== option && "opacity-50 cursor-not-allowed"
            )}
          >
